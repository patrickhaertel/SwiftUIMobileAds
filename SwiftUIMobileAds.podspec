#
#  Be sure to run `pod spec lint SwiftUIMobileAds.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SwiftUIMobileAds"
  spec.version      = "0.1.0"
  spec.summary      = "SwiftUIMobileAds allows you to integrate v8 of the Google Mobile Ads SDK into your SwiftUI app."
...
spec.license      = { :type => "MIT", :file => "LICENSE" }
  ...
  spec.author             = { "Patrick Haertel" => "patrickhaertel@icloud.com" }
  # Or just: spec.author    = "Patrick Haertel"
  # spec.authors            = { "Patrick Haertel" => "patrickhaertel@icloud.com" }
    spec.social_media_url   = "https://twitter.com/phaertel29"
  ...
  spec.source_files  = "SwiftUIMobileAds/**/*.{h,m}"
